...
UNK_VOCAB = '[UNK]'
NULL_VOCAB = '[NULL]'
PINYIN_DISTANCE_MATRIX = pickle.load(open('/home/wbx/LLaMA-Factory/data-generator/cscd/data/resource/pinyin_distance_matrix.pkl', 'rb'))
VALID_PINYIN = {a for (a, b) in PINYIN_DISTANCE_MATRIX.keys()}
lac = LAC(mode='lac')
lm = kenlm.Model('/home/wbx/LLaMA-Factory/data-generator/cscd/data/resource/char_4_gram.bin')
